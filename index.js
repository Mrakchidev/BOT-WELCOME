...
client.on('guildMemberAdd', async member => {
    ...
    const row = new MessageActionRow()
        .addComponents(
            new MessageButton()
                .setStyle('LINK')
                .setURL('https://www.youtube.com/@mrakchi26')       // link to button 1
                .setLabel('YouTube')                                 // name of button 1
                .setEmoji('<:Youtubee:1158819353953828984>'),       // emoji of button 1
            new MessageButton()
                .setStyle('LINK')
                .setURL('link')           // link to button 2
                .setLabel('name')                               // name of button 2
                .setEmoji('emoji'),      // emoji of button 2
            new MessageButton()
                .setStyle('LINK')
                .setURL('link')                // link to button 3
                .setLabel('name')                          // name of button 3
                .setEmoji('')      // emoji of button 3
        );
